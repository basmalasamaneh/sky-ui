                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    <div className="flex items-center justify-center md:justify-start gap-3 mb-1">
                      <h1 className="text-3xl md:text-4xl font-bold text-[#3b2012] dark:text-[#e8dcc4]">{artistData.name}</h1>
                    ...
                    <p className="text-[#9c7b65] dark:text-[#e8dcc4] font-medium text-lg">فنان مبدع</p>
                  ...
                  {!isAuthenticated ? (
                    ...
                    <div className="bg-[#fcfbf9] dark:bg-[#1a0f0a] border border-[#e8dcc4] dark:border-gray-800 rounded-xl px-4 py-3 flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        ...
                        {artistData.location ? (
                          <span className="text-sm font-bold text-[#3b2012] dark:text-[#e8dcc4]">{artistData.location}</span>
                        ) : (
                  ...
                  {!isAuthenticated ? (
                    ...
                    <div className="bg-[#fcfbf9] dark:bg-[#1a0f0a] border border-[#e8dcc4] dark:border-gray-800 rounded-xl px-4 py-3 flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        ...
                        {artistData.phone ? (
                          <span className="text-sm font-bold text-[#3b2012] dark:text-[#e8dcc4]" dir="ltr">{artistData.phone}</span>
                        ) : (
                          <span className="text-xs text-gray-400">غير محدد</span>
                        )}
                      </div>
                  ...
                  {!isAuthenticated ? (
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-1.5 mt-1">
                          {['fa-instagram', 'fa-facebook-f', 'fa-x-twitter'].map((icon, i) => (
                            <div key={i} className="w-7 h-7 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center blur-sm select-none">
                    ...
                    <div className="flex items-center gap-2 pt-1">
                      {artistData.socialMedia.map((social, index) => {
                        let icon = 'fa-link';
                        let colorClass = 'bg-gray-50 dark:bg-gray-900 text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 dark:bg-gray-800 hover:text-gray-900 dark:text-[#e8dcc4] border-[#e8dcc4] dark:border-gray-800';
                        ...
                        else if (p === 'x') { icon = 'fa-x-twitter'; colorClass = 'bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-[#e8dcc4] hover:bg-gray-200 hover:text-black border-gray-200 dark:border-gray-700 dark:border-gray-700'; }
