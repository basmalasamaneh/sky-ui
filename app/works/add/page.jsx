      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-[3rem] p-8 md:p-12 border border-[#e8dcc4] shadow-2xl overflow-hidden relative">
          ...
          <div className="flex flex-col items-center mb-12">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-[#3b2012] font-art mb-2">إضافة عمل فني جديد</h1>
            <p className="text-[#9c7b65] text-center max-w-md">شارك إبداعك مع مجتمع أثر وأضف قطعة فنية جديدة لملفك الشخصي.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                <label className="block text-sm font-bold text-[#3b2012] mb-3 pr-2">عنوان العمل الفني <span className="text-red-500">*</span></label>
              ...
              <div className="flex-1 bg-[#fdfaf7] rounded-[2rem] border-2 border-dashed border-[#e8dcc4] p-4 flex flex-col relative min-h-[400px]">
                {images.length > 0 ? (
                  <div className="flex flex-col h-full gap-4">
                    ...
                    <p className="text-xs text-[#9c7b65] text-center mt-2 font-bold">اضغط على أي صورة لتعيينها كصورة العرض الرئيسية</p>
                  </div>
                ) : (
                  <div className="flex flex-col items-center justify-center h-full text-[#ceb29f]">
                    ...
                    <p className="text-sm font-bold font-art text-[#9c7b65]">قم برفع الصور لتظهر المعاينة هنا</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="lg:col-span-2 pt-8 border-t border-[#f0ece6] mt-4">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
                  ...
                  <Link 
                    href="/works/my"
                    className="w-full sm:w-auto text-center text-[#9c7b65] font-bold hover:text-[#3b2012] bg-[#f0ece6] hover:bg-[#e8dcc4] px-8 py-4 rounded-2xl transition-colors"
                  >
                    إلغاء
                  </Link>
                </div>
