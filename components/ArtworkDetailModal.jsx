  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white dark:bg-black w-full max-w-5xl h-[92vh] md:max-h-[90vh] md:h-auto overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row relative"
      ...
      >
        ...
        <div className="md:w-1/2 bg-[#fdfaf7] dark:bg-black relative h-[32vh] md:h-auto shrink-0 border-l border-[#e8dcc4]/50">
        ...
        {/* Right Side: Details */}
        <div className="md:w-1/2 flex-1 min-h-0 p-5 md:p-10 overflow-y-auto bg-white dark:bg-black flex flex-col no-scrollbar" dir="rtl">
          {isLoadingDetails ? (
            <div className="flex flex-col items-center justify-center h-full text-center gap-6">
              <div className="w-16 h-16 border-4 border-[#3b2012] border-t-transparent rounded-full animate-spin"></div>
              <p className="text-[#9c7b65] dark:text-[#e8dcc4] font-bold">جاري تحميل تفاصيل العمل الفني...</p>
            </div>
            ...
            <div className="space-y-5 md:space-y-8 animate-fade-in">
              <div className="space-y-2">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="text-[10px] bg-[#f0ece6] dark:bg-black text-[#6b4c3b] px-3 py-1 rounded-full font-bold uppercase tracking-widest">
                    عرض للزوار
                  </span>
                </div>
                <h2 className="text-2xl md:text-4xl font-bold text-[#3b2012] dark:text-[#e8dcc4] font-art leading-tight">
                  {work.title}
                </h2>
              </div>
              ...
              <div className="p-6 bg-[#fdfaf7] dark:bg-black rounded-[2rem] border border-[#e8dcc4]/50 space-y-6">
                <Link href={`/artists/${work.artist_id}`} className="flex items-center gap-4 group/artist" onClick={onClose}>
                  <div className="relative w-14 h-14 bg-[#f0ece6] dark:bg-black rounded-full flex items-center justify-center text-[#6b4c3b] text-xl font-bold shadow-md transition-transform group-hover/artist:scale-110 overflow-hidden border-2 border-white">
                    <img 
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-[#9c7b65] dark:text-[#e8dcc4] mb-0.5">الفنان المبدع</p>
                    <p className="text-lg font-bold text-[#3b2012] dark:text-[#e8dcc4] group-hover/artist:text-[#6b4c3b] transition-colors">{work.artistName || 'غير متوفر'}</p>
                  </div>
                </Link>

                <div className="grid grid-cols-2 gap-4">
                  <Link href="/login" className="relative overflow-hidden bg-white dark:bg-black p-4 rounded-2xl border border-[#e8dcc4]/30 shadow-sm flex items-center gap-3">
                ...
                <Link href="/login" className="bg-white dark:bg-black dark:black/80 dark:bg-black/80 border border-[#e8dcc4] dark:border-gray-800 hover:border-[#6b4c3b] hover:bg-[#fdfaf7] dark:bg-black rounded-2xl p-4 flex items-start gap-3 transition-colors">
                  <div className="w-11 h-11 shrink-0 rounded-xl bg-[#f0ece6] dark:bg-black text-[#6b4c3b] flex items-center justify-center">
                    <i className="fa-solid fa-user-lock"></i>
                  </div>
                  <div className="flex-1">
                    <p className="text-sm font-bold text-[#3b2012] dark:text-[#e8dcc4]">أنشئ حساباً للوصول إلى معلومات التواصل</p>
                    <p className="text-xs text-[#9c7b65] dark:text-[#e8dcc4] mt-1 leading-relaxed">سجّل الدخول أو أنشئ حساباً جديداً لرؤية موقع الفنان ورقم التواصل والتفاعل الكامل مع الأعمال الفنية.</p>
                  </div>
                </Link>
              </div>
              ...
              <div className="pt-8 border-t border-gray-100 dark:border-gray-800 dark:border-gray-800 flex items-center justify-between gap-4 flex-wrap">
                ...
                <div className="flex gap-3 flex-wrap">
                  ...
                  <Link href="/login" className="h-14 px-6 bg-[#f0ece6] dark:bg-black text-[#6b4c3b] rounded-2xl font-bold flex items-center justify-center hover:bg-[#e8dcc4] transition-all">
                    تسجيل الدخول
                  </Link>
                </div>
              </div>
              ...
              <div className="p-6 bg-[#fdfaf7] dark:bg-black rounded-[2rem] border border-[#e8dcc4]/50 space-y-6">
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-lg font-bold text-[#3b2012] dark:text-[#e8dcc4] group-hover/artist:text-[#6b4c3b] transition-colors">{user?.artistName || `${user?.firstName || ''} ${user?.lastName || ''}`.trim()}</p>
                  </div>
                </Link>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white dark:bg-black p-4 rounded-2xl border border-[#e8dcc4]/30 shadow-sm flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[10px] text-gray-400">الموقع</p>
                      <p className="text-sm font-bold text-[#3b2012] dark:text-[#e8dcc4]">{user?.location || work.artistLocation || 'غير محدد'}</p>
                    </div>
                  </div>
                  <div className="bg-white dark:bg-black p-4 rounded-2xl border border-[#e8dcc4]/30 shadow-sm flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[10px] text-gray-400">رقم التواصل</p>
                      <p className="text-sm font-bold text-[#3b2012] dark:text-[#e8dcc4] font-mono tracking-wider" dir="ltr">{user?.phone || work.artistPhone || 'غير محدد'}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="p-6 bg-[#fdfaf7] dark:bg-black rounded-[2rem] border border-[#e8dcc4]/50 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white dark:bg-black p-4 rounded-2xl border border-[#e8dcc4]/30 shadow-sm flex items-center gap-3 group">
                    ...
                    <div>
                      <p className="text-[10px] text-gray-400">الموقع</p>
                      <p className="text-sm font-bold text-[#3b2012] dark:text-[#e8dcc4]">{work.artistLocation || 'غير محدد'}</p>
                    </div>
                  </div>
                  <div className="bg-white dark:bg-black p-4 rounded-2xl border border-[#e8dcc4]/30 shadow-sm flex items-center gap-3 group">
                    ...
                    <div>
                      <p className="text-[10px] text-gray-400">رقم التواصل</p>
                      <p className="text-sm font-bold text-[#3b2012] dark:text-[#e8dcc4] font-mono tracking-wider" dir="ltr">{work.artistPhone || 'غير محدد'}</p>
                    </div>
                  </div>
                </div>
              </div>
