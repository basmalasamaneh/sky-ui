              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex flex-col items-center mb-6">
                  <div className="relative group/avatar cursor-pointer">
                    ...
                    />
                    <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-white shadow-lg bg-[#f0ece6] dark:bg-black flex items-center justify-center relative transition-transform group-hover/avatar:scale-105">
                  ...
                  <p className="text-xs text-[#9c7b65] dark:text-[#e8dcc4] font-bold mt-2">صورتك الشخصية</p>
